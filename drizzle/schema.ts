import { pgTable, check, char, date, point, real, serial, integer, varchar, text, foreignKey, primaryKey, timestamp, smallint, boolean, pgView, pgEnum } from "drizzle-orm/pg-core"
...
export const toBeReviewedProofMaterial = pgTable("to_be_reviewed_proof_material", {
	...
	proofMaterial: unknown("proof_material").notNull(),
}, (table) => {
	return {
